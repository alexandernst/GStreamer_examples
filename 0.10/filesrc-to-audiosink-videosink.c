...
int main (int argc, char **argv){
	...
	GMainLoop *loop;
	GstElement *pipeline, *file_src, *decodebin2, *queuea, *audioconvert, *audioresample, *audio_sink, *queuev, *ffmpegcolorspace, *videoscale, *videorate, *video_caps, *ffmpegcolorspace2, *video_sink;
	GstBus *bus;
	...
	gst_bin_add_many(pipeline, file_src, decodebin2, queuea, audioconvert, audioresample, audio_sink, queuev, ffmpegcolorspace, videoscale, videorate, video_caps, ffmpegcolorspace2, video_sink, NULL);
